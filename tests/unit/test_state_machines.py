...
class TestPropositionTransitions:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (TruthStatus.DENIED, TruthStatus.ACCEPTED),
            (TruthStatus.DENIED, TruthStatus.REPORTED),
            ...
            (TruthStatus.CONTESTED, TruthStatus.REPORTED),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (TruthStatus.DENIED, TruthStatus.DENIED),
